...
public class ListadoGeneral extends JFrame{
    ...
    public ListadoGeneral(Jlistado JL,MenuPrincipal MP){
        super("Ingresar");
        this.JL = JL;
        this.MP = MP;
        setSize(900, 300);
    ...
    private void crearGUI() {
        ...
        String encabezados[] = {"Id trabajador", "informacion", "turno","bachiller","Pregrado","posgrado","idioma","basico","intermendio","avanzado","acceso"};
        String datos[][] = {{"", "", "", "", "", "", "", "", "", "", ""}};
