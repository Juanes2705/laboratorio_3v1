...
public class ListadorCaracteres extends javax.swing.text.PlainDocument{
    ...
    public ListadorCaracteres(javax.swing.text.JTextComponent editor, int numeroMaximoCaracteres, int tipo)
    {
        this.editor=editor;
